#The BB (Backseat Baller) Radar App - bb-radars.streamlit.app
...
## V1.1 Update (Released 15/10/25)
- Added data for the 25/26 European season
- Added 4 new leagues (Championship, Primera Liga, Serie B and Eredivisie)
- Improved player selection functionality/logic via a league selection box
- Adjusted caption text on plots to mention the app name
- Fixed an issue where selecting a loaned player displayed incorrect information
